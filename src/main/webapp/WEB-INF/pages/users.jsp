...
<div class="container">
    ...
    <div>
        <table>
            <tr>
                <td>
                    <form:form action="/" method="get"><input class="button24" type="submit" size="XSmall" value="All"/>
                    </form:form>
                </td>
                <td>
                    <form:form action="/filter/Admin" method="post"><input class="button24" type="submit" size="XSmall" value="Admin"/>
                    </form:form>
                </td>
                <td>
                    <form:form action="/filter/noAdmin" method="post"><input class="button24" type="submit" size="XSmall"
                                                                             value="noAdmin"/>
                    </form:form>
                </td>
            </tr>
            ...
            <c:forEach items="${users}" var="user">
                <tr bgcolor="#f0ffff">
                    ...
                    <td bgcolor="#f0ffff" class="td1" width="80px">
                        <table>
                            <tr bgcolor="#f0ffff">
                                <td bgcolor="#f0ffff"><form:form action="edit/${user.id}" method="post"><input type="submit" size="XSmall"
                                                                                             value="Edit"/>
                                </form:form></td>
                                <td bgcolor="#f0ffff"><form:form action="remove/${user.id}" method="post"><input type="submit"
                                                                                               size="XSmall"
                                                                                               value="Delete"/>
                                </form:form></td>
                            </tr>
